...
namespace Tyuiu.StachinskiiVS.Sprint6.Task4.V4
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 4 выполнил студент группы ИСПб-24-1 Стачинский В.С.", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
